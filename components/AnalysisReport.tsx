                        ...
                        <div key={sent.id} className="avoid-break border rounded-xl overflow-hidden shadow-sm border-gray-200">
                             ...
                             <div className="bg-white p-3 border-b border-gray-100">
                                <div className="flex items-start gap-3">
                                    <div className="flex-shrink-0 bg-indigo-600 text-white w-6 h-6 rounded-full flex items-center justify-center font-bold text-[9pt] shadow-sm mt-1">
                                        {idx + 1}
                                    </div>
                             ...
                             <div className="flex border-b border-gray-100">
                                 <div className="w-12 flex-shrink-0 bg-gray-50 flex items-center justify-center border-r border-gray-100">
                                     <span className="text-[8pt] font-bold text-gray-500">해석</span>
                                 </div>
                                 <div className="p-3 text-[9pt] text-gray-700 leading-relaxed font-medium">
                                     {sent.translation}
                                 </div>
                             </div>
                             ...
                             {sent.grammarNotes.length > 0 && (
                                <div className="flex bg-blue-50/30">
                                     <div className="w-12 flex-shrink-0 bg-indigo-50 flex items-center justify-center border-r border-indigo-100">
